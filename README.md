...
3. Words that have a consonant as first letter, and a vowel as second letter, and a consonent as third letter, must be altered by inserting an "n" between the first and second letter (e.g. "human" -> "hnuman")
4. Rule #3 also applies to words where the third letter is the same as the second letter (e.g. "google" -> "gnoogle")
